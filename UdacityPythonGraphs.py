...
class Graph(object):
    ...
    def get_adjacency_list(self):
        ...
        try:
            ...
            for edge in self.edges:
                current_values = adjacency_list[edge.node_from.value]
                if current_values == None:
                    adjacency_list[edge.node_from.value] = [(edge.node_to.value, edge.value)]
                else:
                    current_values.append((edge.node_to.value, edge.value))
                    adjacency_list[edge.node_from.value] = current_values
